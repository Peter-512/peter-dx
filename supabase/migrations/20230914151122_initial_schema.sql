...
ALTER TABLE "public"."project_team_members" ALTER COLUMN "project_id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."project_team_members_project_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE "public"."project_team_members" ALTER COLUMN "team_member_id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."project_team_members_team_member_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."project_team_members"
    ADD CONSTRAINT "project_team_members_pkey" PRIMARY KEY ("team_member_id", "project_id");
...
GRANT ALL ON SEQUENCE "public"."project_team_members_project_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."project_team_members_project_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."project_team_members_project_id_seq" TO "service_role";

GRANT ALL ON SEQUENCE "public"."project_team_members_team_member_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."project_team_members_team_member_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."project_team_members_team_member_id_seq" TO "service_role";
